...
# ─── ENVIO PARA GRUPO ───────────────────────────────────────────────────────────
def send_group_message(group_id: str, text: str):
    # group_id ex: "120363417892303891-group"
    send_whatsapp_message(group_id, text)
...
def webhook():
    ...
    cliente = data.get("senderName", "").strip()   # nome do contato
